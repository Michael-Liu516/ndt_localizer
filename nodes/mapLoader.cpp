...
sensor_msgs::PointCloud2 MapLoader::TransformMap(sensor_msgs::PointCloud2& in) {
  ...
  pcl::PointCloud<pcl::PointXYZ>::Ptr transformed_pc_ptr(
      new pcl::PointCloud<pcl::PointXYZ>);

  Eigen::Translation3f tl_m2w(tf_x_, tf_y_, tf_z_);  // tl: translation
  Eigen::AngleAxisf rot_x_m2w(tf_roll_,
  ...
  Eigen::Matrix4f tf_m2w =
      (tl_m2w * rot_z_m2w * rot_y_m2w * rot_x_m2w).matrix();
